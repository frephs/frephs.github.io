...
const projects: Project[] = [
    {
        ...
        icon: "🏫",
        preview: true,
        description: "Room finder and availability checker for Politecnico di Milano",
    ...
    },
    {
      ...
      icon: "✅",
      preview: false,
      description: "A Nautilus extension for managing todos directly from the file manager",
    ...
    icon: "🏳️‍🌈",
    preview: true,
    description: "A platform to celebrate diversity and inclusion at Politecnico di Milano",
  ...
  },
  {
    ...
    icon: "🌐",
    preview: false,
    description: "Mathematical and visual exploration of synchronizing automata and their pathways",
  ...
  }, 
  {
    ...
    icon: "📜",
    preview: false,
    description: "Multiplayer board game adaptation of the Codex Naturalis game",
    tech: ["Java", "Networking", "Software Engineering", "JavaFX"]
  }, {
    name: "YourAuction",
    link: "https://frephs.github.io/tiw-project-2025/",
    icon: "🛒",
    preview: true,
    description: "A platform for managing online auctions with real-time bidding",
    ...
    icon: "📅",
    preview: false,
    description: "A browser extension to visualize exam schedules at Politecnico di Milano",
    tech: ["Web Development", "TypeScript"]
  }
    ...
    <section id="projects" className="projects-section">
      ...
      <div className="projects-grid">
        {projects.map((project, index) => (
          <div key={index} className={`project-card ${!project.preview ? 'no-preview' : ''}`}>
            <a
              href={project.link}
              target="_blank"
