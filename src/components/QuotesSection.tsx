...
const quotes: Quote[] = [
  ...
  },
  {
    author: "Karl Marx",
    quote:
      "In the modern industry the means of production must become means of production in common, social means of production, and, as such, they are employed in common, and produce, not privately for the individual producer, but socially.\n\nFrom each according to their ability, to everyone according to their needs.\n\nThe ideas of the ruling class are in every epoch the ruling ideas, i.e., the class which is the ruling material force of society, is at the same time its ruling intellectual force.",
  },
  {
    author: "Pravin Lal",
    quote:
